            ...
            <div className="bg-gray-50 min-h-screen pt-24 pb-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {listings.length > 0 ? (
                        ...
                        <div className="bg-white border border-brand-border/40 p-12 text-center rounded-sm">
                            ...
                            <p className="text-brand-text-muted">
                                We couldn&apos;t find any listings matching your current filters. Try broadening your
                    ...
                    <div className="mt-12 bg-white border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d185000!2d-80.3123!3d43.3616!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sca"
                            width="100%"
                            height="350"
                            style={{ border: 0 }}
                            allowFullScreen
