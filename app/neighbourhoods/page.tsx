        ...
        <div className="bg-brand-bg min-h-screen pt-[124px] lg:pt-[136px] pb-16 border-t border-brand-border/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-8 md:mb-12">
                    <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-brand-text mb-6">
                        <span className="italic text-brand-accent">Neighbourhoods</span> of{' '}
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="prose prose-lg prose-brand max-w-none text-brand-text-muted font-light leading-relaxed my-16">
                    ...
                    <p>
                        The Waterloo Region is composed of three primary cities (Kitchener, Waterloo, and Cambridge) and
                        several surrounding townships. While they operate as one interconnected metropolitan area, each
                        city, and each neighbourhood within them, has its own distinct character, property values, and
                        pace of life.
                    </p>
                    <p>
                        If you&apos;re relocating for work in the tech sector, you might gravitate towards Uptown
                        Waterloo or the Innovation District in downtown Kitchener. If you&apos;re looking for larger
                        lots, mature trees, and excellent family schools, you might look at Beechwood (Waterloo),
                    ...
                    <p>
                        ...
                        Downtown has seen heavy investment with the LRT bringing new condo developments, while the outer
                        rings offer established, diverse, family-friendly neighbourhoods with great parks and highway
                        access. Areas like <strong>Doon</strong> and <strong>Pioneer Park</strong> are deeply popular
                        with families looking for space and easy commuting.
                    </p>

                    <h3 className="font-display text-2xl mt-12 mb-6 text-brand-text">Waterloo: Academic & Tech Hub</h3>
                    <p>
                        Home to two major universities and leading tech companies, Waterloo tends to carry a slight
                        price premium over Kitchener and Cambridge. The uptown core is highly walkable, filled with
                        independent restaurants, and surrounded by older, prestigious neighbourhoods like{' '}
                        <strong>Westmount</strong>. Further out, areas like <strong>Eastbridge</strong> and{' '}
